    ...
    while($row = $result->fetch_assoc()){
      echo '<tr>
        ...
        <td>
          ...
          <form action="sellproduct.php" method="POST" class="d-inline"><input type="hidden" name="id" value='. $row["pid"] .'><button type="submit" class="btn btn-warning" name="issue" value="Issue"><i class="fas fa-handshake"></i></button></form>
        </td>
      </tr>';
    }
    echo '</tbody>
...
<div class="float-right" ><a href="addproduct.php" class="btn btn-primary"><i class="fas fa-plus fa-2x"></i></a></div>
</div>
